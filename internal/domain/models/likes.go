...
type Like struct {
	...
	PostID    nuuid.NullUUID `boil:"post_id" json:"post_id,omitempty" toml:"post_id" yaml:"post_id,omitempty"`
	CommentID nuuid.NullUUID `boil:"comment_id" json:"comment_id,omitempty" toml:"comment_id" yaml:"comment_id,omitempty"`
...
var LikeWhere = struct {
	...
	PostID    whereHelpernuuid_NullUUID
	CommentID whereHelpernuuid_NullUUID
}{
	ID:        whereHelperuuid_UUID{field: "\"likes\".\"id\""},
	CreatedAt: whereHelpernull_Time{field: "\"likes\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"likes\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"likes\".\"deleted_at\""},
	Value:     whereHelperint{field: "\"likes\".\"value\""},
	UserID:    whereHelperuuid_UUID{field: "\"likes\".\"user_id\""},
	PostID:    whereHelpernuuid_NullUUID{field: "\"likes\".\"post_id\""},
	CommentID: whereHelpernuuid_NullUUID{field: "\"likes\".\"comment_id\""},
}
...
func (r *likeR) GetComment() *Comment {
	if r == nil {
		return nil
	}
	return r.Comment
...
var (
	likeAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "value", "user_id", "post_id", "comment_id"}
	likeColumnsWithoutDefault = []string{"id", "value", "user_id"}
	likeColumnsWithDefault    = []string{"created_at", "updated_at", "deleted_at", "post_id", "comment_id"}
...
func (o *Like) Comment(mods ...qm.QueryMod) commentQuery {
...
func (likeL) LoadComment(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLike interface{}, mods queries.Applicator) error {
	var slice []*Like
	var object *Like
...
// SetComment of the like to the related item.
// Sets o.R.Comment to related.
// Adds o to related.R.Likes.
func (o *Like) SetComment(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Comment) error {
	var err error
	if insert {
...
func (o *Like) RemoveComment(ctx context.Context, exec boil.ContextExecutor, related *Comment) error {
	var err error
	...
	for i, ri := range related.R.Likes {
		if queries.Equal(o.CommentID, ri.CommentID) {
			continue
		}

		ln := len(related.R.Likes)
		if ln > 1 && i < ln-1 {
			related.R.Likes[i] = related.R.Likes[ln-1]
		}
		related.R.Likes = related.R.Likes[:ln-1]
		break
	}
	return nil
}
...
// Removes o from all passed in related items' relationships struct.
func (o *Like) RemovePost(ctx context.Context, exec boil.ContextExecutor, related *Post) error {
	var err error
...
func Likes(mods ...qm.QueryMod) likeQuery {
	mods = append(mods, qm.From("\"likes\""), qmhelper.WhereIsNull("\"likes\".\"deleted_at\""))
	q := NewQuery(mods...)
...
func FindLike(ctx context.Context, exec boil.ContextExecutor, iD uuid.UUID, selectCols ...string) (*Like, error) {
	likeObj := &Like{}
	...
	query := fmt.Sprintf(
		"select %s from \"likes\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *Like) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE \"likes\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
		valueMapping, err := queries.BindMapping(likeType, likeMapping, append(wl, likePrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
...
func (q likeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
...
func (o LikeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"likes\" SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 2, likePrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func LikeExists(ctx context.Context, exec boil.ContextExecutor, iD uuid.UUID) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"likes\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
